...
def main(rover_input: str) -> str:
    ...
    # Split up the rover inputs
    # into first lines (coordinates and direction)
    # and second lines (movement letters)
    ...
    final_rovers = []
    # zip the two lists together so we can run both lines for one rover at a time
    for first_line, second_line in zip(rovers_first_lines, rovers_second_lines):
        # Get current position and direction of the rover
        ...
        # iterate over each movement letter
        ...
        # Create the final rover coordinate and direction string
